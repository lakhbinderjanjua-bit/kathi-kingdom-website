...
const menu = [
  {
    name: "Paneer Tikka Masala Roll",
    desc: "Rich paneer filling with a spicy, indulgent finish.",
  },
  {
    name: "Chilli Potato Roll",
    desc: "Street-style comfort with a crisp and saucy kick.",
  },
  {
    name: "Signature Kathi Rolls",
    desc: "The core of the kingdom — bold, filling, and satisfying.",
  },
];
          ...
          <div className="container hero-grid">
            <div>
              ...
              <p className="hero-copy">
                Kathi Kingdom is a royal-themed cloud kitchen in Nagpur serving
                flavour-packed Kathi rolls, available on Zomato, Swiggy, and Instagram.
              </p>

              <div className="cta-row">
                <a className="btn btn-primary" href={links.zomato} target="_blank" rel="noreferrer">
                  Order on Zomato
                </a>
                <a className="btn btn-secondary" href={links.swiggy} target="_blank" rel="noreferrer">
                  Order on Swiggy
                </a>
                <a className="btn btn-light" href={links.instagram} target="_blank" rel="noreferrer">
                  Follow Instagram
                </a>
              </div>
        ...
        <section id="about" className="section">
          <div className="container">
            <div className="section-head">
              ...
              <p>
                The brand is built around indulgent flavour, premium presentation,
        ...
        <section id="menu" className="section section-dark">
          <div className="container">
            <div className="section-head">
              ...
              <p>
                A premium first impression for customers before they head to the delivery apps.
              </p>
            </div>
            ...
            <div className="card-grid">
              {menu.map((item) => (
                <div key={item.name} className="menu-card">
                  ...
                  <h3>{item.name}</h3>
                  <p>{item.desc}</p>
                  <a href={links.zomato} target="_blank" rel="noreferrer">
                    View Online
                  </a>
                </div>
              ))}
          ...
          <div className="container">
            ...
            <div className="order-grid">
              ...
              <div className="order-card">
                ...
                <p>
                  Reach more customers across Nagpur through another trusted delivery app.
                </p>
                <a className="btn btn-secondary" href={links.swiggy} target="_blank" rel="noreferrer">
                  Open Swiggy
                </a>
          ...
          <div className="container social-grid">
            <div>
              ...
              <p className="social-copy">
                Use <strong>@kathikingdom</strong> to showcase bestsellers,
                limited-time offers, and the personality behind your brand.
              </p>
              <a className="btn btn-light" href={links.instagram} target="_blank" rel="noreferrer">
                Visit Instagram
              </a>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div className="brand">
            ...
            <div>
              ...
              <div className="brand-sub footer-sub">
                Cloud kitchen in Nagpur, Maharashtra
              </div>
            </div>
          </div>
          ...
          <div className="footer-links">
            ...
            <a href={links.swiggy} target="_blank" rel="noreferrer">
              Swiggy
            </a>
